...
- Bump `org.webjars:font-awesome` from 6.7.2 to 7.2.0 ([#50](https://github.com/OHSU-OCTRI/common-lib/pull/50))
- Bump `org.springframework.boot:spring-boot-starter-parent` from 3.5.11 to 3.5.14 ([#48](https://github.com/OHSU-OCTRI/common-lib/pull/48))
...
- Set the `autoWidth` DataTable option to false, to ensure that tables are full width (OPEN-363)
...
[unreleased]: https://github.com/OHSU-OCTRI/common-lib/compare/v2.1.0...HEAD
[2.1.0]: https://github.com/OHSU-OCTRI/common-lib/compare/v2.0.1...v2.1.0
[2.0.1]: https://github.com/OHSU-OCTRI/common-lib/compare/v2.0.0...v2.0.1
[2.0.0]: https://github.com/OHSU-OCTRI/common-lib/compare/v1.8.0...v2.0.0
